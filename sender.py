...
WEBSITE_URL = "http://chesteracornson.duckdns.org:8080/"
...
def send_email(image_url,email):
    ...
    <html>
      <body style="font-family: Arial, sans-serif; color: #333;">
        ...
        <div style="margin-top: 25px; padding-top: 15px; text-align: center; border-top: 1px solid #eee;">
            <p style="margin-bottom: 5px;">Want more Chester Acornson?</p>
            <a href="{WEBSITE_URL}" style="display: inline-block; padding: 10px 20px; background-color: #8B4513; color: #ffffff; text-decoration: none; border-radius: 5px; font-weight: bold;">Visit the Squirrel HQ</a>
            <p style="font-size: 0.85em; color: #888; margin-top: 20px;">Stay bright and bushy-tailed!</p>
        </div>
